...
import { IconBan, IconCalendarCode, IconChevronDown, IconChevronLeft, IconChevronRight, IconChevronUp, IconHelp, IconCode } from '@tabler/icons-react';
...
export const NAV_SECTIONS: NavSection[] = [
    {
        id: 'prohibitions',
        label: 'Prohibitions',
        renderIcon: () => <IconBan size={20} />,
    },
    {
        id: 'obligations',
        label: 'Obligations',
        renderIcon: () => <IconCalendarCode size={20} />,
    },
    {
        id: 'admin-operations',
        label: 'Admin Operations',
        renderIcon: () => <AdminOperationIcon size={20} />,
    },
    {
        id: 'resource-operations',
        label: 'Resource Operations',
        renderIcon: () => <ResourceOperationIcon size={20} />,
    },
    {
        id: 'queries',
        label: 'Queries',
        renderIcon: () => <QueryOperationIcon size={20} />,
    },
    {
        id: 'routines',
        label: 'Routines',
        renderIcon: () => <RoutineIcon size={20} />,
    },
    {
        id: 'functions',
        label: 'Functions',
        renderIcon: () => <FunctionIcon size={20} />,
    },
    {
        id: 'pml',
        label: 'PML Editor',
...
export function DashboardSidebar({ collapsed, onCollapse, activeId, onNavigate }: Props) {
                ...
                <Tooltip label="User Attributes" position="right" disabled={!collapsed} withinPortal>
                    ...
                    >
                        <span style={{ flexShrink: 0, display: 'flex' }}>
                            <NodeIcon type={NodeType.UA} size={20} style={{ color: 'currentColor', border: '2px solid currentColor' }} />
                        </span>
